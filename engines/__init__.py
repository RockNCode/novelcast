...
def get_engine(name: str = "omnivoice", **kwargs) -> BaseTTSEngine:
    ...
    if name == "omnivoice":
        ...
        raise ValueError(f"Unknown TTS engine '{name}'. Supported: omnivoice, cosyvoice, kokoro, elevenlabs")

__all__ = ["BaseTTSEngine", "OmniVoiceEngine", "CosyVoiceEngine", "KokoroEngine", "ElevenLabsEngine", "get_engine"]
